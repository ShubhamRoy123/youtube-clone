...
export const PlaylistThumbnailSkeleton = () => {
  return (
    <div className="relative w-full overflow-hidden rounnded-xl aspect-video">
...
export const PlaylistThumbnail = ({
  ...
  return (
    <div className={cn("relative pt-3", className)}>
      ...
      <div className="absolute bottom-2 right-2 px-1 pt-0.5 rounded bg-black/80 text-white text-xs font-medium flex items-center gap-x-1">
